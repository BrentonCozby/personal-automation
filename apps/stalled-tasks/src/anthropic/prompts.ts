...
export function buildAnalysisPrompt({
  ...
  return `You are my weekly task reviewer. I have ADHD-pattern executive-function challenges, so open tasks pile up and stall for different reasons. For each open Apple Reminder below, judge WHY it has stalled and give me one concrete next action I can start now.
